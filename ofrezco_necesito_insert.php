	...
	<div class="mod-form">
 		...
 		<div class="form-group ">
			<form name="f1" action="ofrezco_necesito_insert.proc.php" method="post" enctype="multipart/form-data" onsubmit="return validar();">
				<h3>Ofrezco</h3>
				<input id="radio" type="radio" name="peticion" <?php if( $user['nivel'] == '0' ) { ?>checked="checked"<?php } ?> value='0' >
				<h3>Necesito</h3>		
				<input id="radio" type="radio" name="peticion" <?php if( $user['nivel'] == '1' ) { ?>checked="checked"<?php } ?> value='1' >
				...
				<div class="form-group">
					<textarea name="descripcion" class="form-control" placeholder="Descripción" rows="5" required></textarea><br>
				</div>
				<div class="form-group">
